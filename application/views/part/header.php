    ...
    <li class="has_sub">
      ...
      <ul class="list-unstyled">
       ...
       <?php } if($userinfo['role_id'] == '1' || check_permission(VIEW,"contact_details")==1){ ?>
        ...
        <?php } if($userinfo['role_id'] == '1' || check_permission(VIEW,"app_category_list")==1){ ?>
        <li><a href="<?php echo site_url(); ?>admin/app/manage_category"><span><?php echo $this->lang->line('app_category_manage'); ?> </span></a></li> 
        <?php }  ?>
