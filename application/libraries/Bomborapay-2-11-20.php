...
class Bomborapay {
   //private $merchant_id = '300211950';
   //private $api_key = '1cAc137274064e6598A4f4E412D33A98';
 ...
 //make a credit card payment
    ...
    echo $submerchant_id;
     ...
     function profile_create($http_method = 'POST', $url, $data = NULL,  $submerchant_id='377010002')
    {
        //377010002
        //$submerchant_id = '377010002';
