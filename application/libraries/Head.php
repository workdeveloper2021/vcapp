...
class Head
{
	...
	var $class_name		    = '';						// Language for meta data
	...
	var $favicon_location 	= 'templates/system/images/favicon.ico'; 	// Location of the favicon if we're using it
	...
	private function _render_html()
	{
		...
		{
			return '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="'.$this->meta_language.'" lang="'.$this->meta_language.'"   class="'.$this->class_name.'">';
		}
		else
		{
			return '<html>';
