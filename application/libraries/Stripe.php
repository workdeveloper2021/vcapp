...
class Stripe
{
    ...
    public function getaccount($key = '')
    {
        ...
        try {
            ...
            \Stripe\Stripe::setApiKey($this->CI->config->item('secret_key'));
    ...
    public function remove_bank_account($bank_account_id, $usid)
    {
        $msg = '';
        try {
            $charge = \Stripe\Customer::deleteSource($usid, $bank_account_id);
            $msg = $charge;
        } catch (Exception $e) {
            $msg = $e->getMessage();
        }
    ...
    public function retrieve_specific_bank_account($bank_account_id, $usid)
    {
        $msg = '';
        try {
            $charge = \Stripe\Customer::retrieveSource($usid, $bank_account_id);
            $msg = $charge;
        } catch (Exception $e) {
            $msg = $e->getMessage();
        }
    ...
    public function retrieve_specific_card($cardid, $usid)
    {
        $msg = '';
        try {
            $charge = \Stripe\Customer::retrieveSource($usid, $cardid);
            $msg = $charge;
        } catch (Exception $e) {
            $msg = $e->getMessage();
        }
