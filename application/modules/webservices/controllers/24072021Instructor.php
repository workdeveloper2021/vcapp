			...
			if ($userdata['status'] != 1) {
				...
				if ($_POST) {
					...
					if ($this->form_validation->run() == FALSE) {
						...
						$collection = $this->dynamic_model->getTwoTableData('meals.id, meals.nutrition_id, meals.diet_name, meals.age, meals.quantity, meals.calories, meals.carbs, meals.protien, meals.fat, meals.calcium, meals.description, meals.file_url, meals.status, manage_nutrition.name as nutrition_name', 'meals', 'manage_nutrition', $on, $condition);
