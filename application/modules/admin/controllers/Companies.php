...
class Companies extends My_Controller {
    ...
    public function index() {
        ...
        $this->admintemplates('companies/companies_list',$data, $header);
    }
    ...
    public function companyAjaxlist(){
        ...
        $totalRecord      = $this->company_model->companyAjaxlist(true);
        $getRecordListing = $this->company_model->companyAjaxlist(false,$start,$length, $column_name, $order[0]['dir']);
    ...
    public function companyprofile($user_id=''){
        ...
        if(!empty($user_id) && !empty($uid)){
            ...
            $this->admintemplates('companies/company-update', $loguserinfo, $header);
        } else{
    ...
    public function addCompany(){
            ...
            $this->admintemplates('companies/company-add', $loguserinfo, $header);
    }
    ...
    public function companyAddSubmit(){
        ...
        if(isset($is_submit) && $is_submit == 1){
            ...
            if ($this->form_validation->run() == FALSE){
                ...
                $updatedata['video_url'] = $vid_name;
                $company_id = $this->dynamic_model->insertdata('manage_company_list', $updatedata); 
