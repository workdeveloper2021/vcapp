...
class Videos extends My_Controller {
    ...
    public function index() {
        ...
        $header['title'] = 'Videos'; // $this->lang->line('user_list'); 
        $data['videos']= $this->dynamic_model->getdatafromtable('video_content',array("status "=> 'Active'),'id');       
        $this->admintemplates('videos/users_list',$data, $header);
    }
