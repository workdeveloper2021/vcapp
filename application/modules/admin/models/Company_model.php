...
class Company_model extends CI_model{
    ...
    public function companyAjaxlist($isCount=false,$start=0,$stop=0, $column_name='',$order='desc'){
        ...
        // $this->db->select('count(company_enter_count.company_id) as visits, manage_company_list.*, manage_comapny_location.location as company_location');
        ...
        // $this->db->join('company_enter_count','company_enter_count.company_id = manage_company_list.id','left'); 
