...
class Furniture_s_model extends CI_model{
    ...
    public function showroomAjaxlist($isCount=false,$start=0,$stop=0, $column_name='',$order='desc',$cid){
        ...
        $this->db->select('manage_showroom_furiture.*');
        $this->db->from('manage_showroom_furiture');
        ...
        $this->db->where('manage_showroom_furiture.company_id ',$cid);
