...
class FurnitureImages_model  extends CI_model{
    ...
    public function showroomAjaxlist($isCount=false,$start=0,$stop=0, $column_name='',$order='desc',$cid){
        ...
        $this->db->select('showroom_furniuture360_image.*');
        $this->db->from('showroom_furniuture360_image');
       
        $this->db->where('showroom_furniuture360_image.showroom_id ',$cid);
