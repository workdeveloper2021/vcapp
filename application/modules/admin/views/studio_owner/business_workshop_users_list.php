...
<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?> 
 ...
 -->                
                ...
                <div class="col-md-6 text-right">
                  ...
                  <a class="btn btn-active waves-effect m-b-10" style="width: 15%;" href="<?php echo base_url("admin/StudioOwner/exportCsvBusinessWorkshopUsers");?>" title="<?php echo $this->lang->line('btn_export_csv_text'); ?>"><?php echo $this->lang->line('btn_export_csv_text'); ?></a>
...
<script type="text/javascript">
        ...
        var postListingUrl =  BASEURL+"admin/classes/get_workshop_attendence_users/"+$("#bid").val()+"/"+$("#cid").val();
