      ...
      <div class="card-box"> 
        ...
        <table id="userList" class="table table-bordered table-responsive">
            ...
            <tr>
              ...
              <th><?php echo $this->lang->line('attendee_name'); ?></th>
              <th><?php echo $this->lang->line('attendee_checkin_time'); ?></th>
              <th><?php echo $this->lang->line('attendee_checkout_time'); ?></th>
              <th><?php echo $this->lang->line('attendee_status'); ?></th>
          </thead>
        </table>
      </div>
    </div>
...
<script type="text/javascript">
        ...
        var postListingUrl =  BASEURL+"admin/classes/businessClassesAttendeeAjaxlist/"+<?php echo $this->session->userdata("sid"); ?>;
