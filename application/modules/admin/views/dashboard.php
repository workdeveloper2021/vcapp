...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card-box widget-user">
            <div class="text-center">
                <h3 class="text-center pb-3 mb-0 box_icon"><i class="fas fa-users"></i></h3>
                <h5><?php echo $this->lang->line('lab_totelusers'); ?></h5>
                <h2 class="text-custom" data-plugin="counterup"><?php //echo $total_user[0]['total_user']; ?></h2>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="card-box widget-user">
            <div class="text-center">
                <h3 class="text-center pb-3 mb-0 box_icon"><i class="fas fa-chalkboard-teacher"></i></h3>
                <h5><?php echo $this->lang->line('lab_totelinstructor'); ?></h5>
                <h2 class="text-custom" data-plugin="counterup"><?php //echo $total_instructor[0]['total_instructor']; ?></h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card-box widget-user">
            <div class="text-center">
                <h3 class="text-center pb-3 mb-0 box_icon"><i class="fas fa-business-time"></i></h3>
                <h5><?php echo $this->lang->line('lab_totelbusiness'); ?></h5>
                <h2 class="text-pink" data-plugin="counterup"><?php //echo $total_business[0]['total_business']; ?></h2>
            </div>
        </div>
    </div>
    <!--
      <div class="col-xl-3 col-md-6">
          <div class="card-box widget-user">
              <div class="text-center">
                  <h2 class="text-warning" data-plugin="counterup"><?php //echo $dashboard_data[0]['active_user']; ?></h2>
                  <h5><?php echo $this->lang->line('lab_activeuser'); ?></h5>
              </div>
          </div>
      </div>
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card-box widget-user">
          <div class="text-center">
            <h2 class="text-warning" data-plugin="counterup"><?php //echo $dashboard_data[0]['inactive_user']; ?></h2>
            <h5><?php echo $this->lang->line('lab_inactiveuser'); ?></h5>
          </div>
        </div>
      </div> -->
</div><!-- end row -->
...
<div class="row">
              ...
              <!-- <div class="col-xl-3 col-md-6">
              <div class="card-box">
                <h4 class="header-title mt-0 m-b-30"><?php echo $this->lang->line('lab_inactiveuser'); ?></h4>
                <div class="widget-chart-1">
                    <div class="text-right">
                        <h2 class="p-t-10 mb-0"> 2666 </h2>
  ...
  /* var options = {
      ...
      data: [{
         ...
         indexLabel: "{y}",
            color: "#546BC1",
         dataPoints: [
             <?php if (!empty($total_user_graph)) {
                     foreach ($total_user_graph as $sub_array) {
   ...
   var optionss = {
      ...
      data: [{
         ...
         indexLabel: "{y}",
            color: "#546BC1",
         dataPoints: [
             <?php if (!empty($total_instructor_graph)) {
                     foreach ($total_instructor_graph as $sub_array) {
                        foreach ($sub_array as $key => $value) {
                           # code...
                           echo ' { label: "'.$key.'", y: '.$value.' },';
                        }
   ...
   $("#chartContainer").CanvasJSChart(options);
    $("#chartContainer1").CanvasJSChart(optionss);*/
});
</script>
