  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="card-box text-center">
            <h4 class="header-title m-t-0 m-b-30"><?php echo $this->lang->line('product_3d_rendered_images'); ?></h4>
            <?php if ($this->session->flashdata('updateerror') != '') { 
              ...
              <table border="" width="100%">
                <thead>
                  <tr>
                    <td>S.No.</td>
                    <td><?php echo $this->lang->line('product_3d_rendered_images'); ?></td>
                    <td><?php echo $this->lang->line('title_placeholder_3d_rendered_img_info'); ?></td>
                  </tr>
                </thead>
                <tbody>
                    ...
                    if(!empty($product_images) && count($product_images)>0){
                      ...
                      <tr>
                        ...
                        <td><img src="<?php echo base_url()."uploads/company_media/".$value["image_name"] ?>" width="80%" /></td>
                        <td><?php echo $value["image_info"]; ?></td>
                        ...
                        ?>
                         ...
                         <tr>
                            <td colspan="2"><?php echo $this->lang->line('no_product_imgs'); ?></td>
                          </tr>
                        <?php
