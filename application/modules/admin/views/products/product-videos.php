  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="card-box text-center">
            <h4 class="header-title m-t-0 m-b-30"><?php echo $this->lang->line('product_video'); ?></h4>
            <?php if ($this->session->flashdata('updateerror') != '') { 
              ...
              <?php 
              if(!empty($product_videos) && count($product_videos)>0){


                foreach ($product_videos as $key => $value) {
                  ?>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                      <div class="form-group">
                        <h4><?php echo $this->lang->line('no_product_video'); ?></h4>
                      </div>
                    </div>                  
                  </div>
