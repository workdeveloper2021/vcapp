...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      <a href="<?php echo site_url();?>admin/trainers" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/trainers/userProfileUpdate', $attributes, $hidden);
            ?>
                  <div class="row">
