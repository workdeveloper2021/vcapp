    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     <div class="row">
        <div class="col-md-6">
         ...
         <form action="<?php echo base_url() ?>admin/categoryMaster/block_categories" class="d-inline" data-parsley-validate novalidate method="post">
             <input type="hidden" name="ids" value="" class="getIds">
             <button type="submit" class="btn btn-primary">Active</button>
         </form>
          <form action="<?php echo base_url() ?>admin/categoryMaster/unblock_categories" class="d-inline" data-parsley-validate novalidate method="post">
             <input type="hidden" name="ids" value="" class="getIds">
         ...
         <!-- <?php } ?> -->
                ...
                <div class="col-md-6 text-right">
                  ...
                  <a class="btn btn-active waves-effect m-b-10" style="width: 15%;" href="<?php echo base_url("admin/categoryMaster/addCat");?>" title="<?php echo $this->lang->line('add_category'); ?>"><?php echo $this->lang->line('add_category'); ?></a>
...
<script type="text/javascript">
        ...
        var postListingUrl =  BASEURL+"admin/categoryMaster/categoryAjaxlist";
