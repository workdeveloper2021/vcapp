    ...
    <div class="col-md-12">
      ...
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/categoryMaster/categoryAdd', $attributes, $hidden);
                 ...
                 <div class="row">
                  ...
                  <div class="form-group">
                    <label for="inputName" class="control-label"><?php echo $this->lang->line('tb_category_name'); ?>
                      ...
                      <input type="text" name="category_name" class="form-control text_name" id="inputName" value="" placeholder="<?php echo $this->lang->line('tb_category_name'); ?>" required>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-12">
                      <button type="submit" class="btn btn-info"><?php echo $this->lang->line('btn_add_category'); ?></button>
                    </div>
                  </div>
             <?php echo form_close(); ?> 
        </div> 
