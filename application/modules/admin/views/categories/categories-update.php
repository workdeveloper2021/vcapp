    ...
    <div class="col-md-12">
      ...
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/categories/categoriesUpdate', $attributes, $hidden);
            ...
            ?>
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                      <label for="inputName" class="control-label"><?php echo $this->lang->line('tb_product_categories_name'); ?>
                        ...
                        <input type="text" name="updatename" class="form-control" id="inputName" value="<?php echo $categories[0]['category_name'] ? $categories[0]['category_name'] : ''; ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="updateid" class="form-control" value="<?php echo $categories[0]['id']; ?>" />
                      <button type="submit" class="btn btn-info"><?php echo $this->lang->line('btn_categories_update'); ?></button>
                    </div>
                  </div>
