    ...
    <div class="col-md-12">
      ...
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/location/locationAddSubmit', $attributes, $hidden);
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-12">
                      <button type="submit" class="btn btn-info"><?php echo $this->lang->line('btn_location_add'); ?></button>
                    </div>
                  </div>
