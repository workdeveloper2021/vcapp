...
<!-- <div class="backlayer-watermark">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">  
     <a href="<?php echo site_url();?>admin/app/category_update" class="btn btn-back"><?php echo $this->lang->line('add_category'); ?></a>  <br /><br />  
      <div class="card-box"> 
        ...
        <table id="planlist" class="table table-bordered">
            ...
            <tr>
              ...
              <th><?php echo $this->lang->line('tb_category_parent_name'); ?></th> 
              <th><?php echo $this->lang->line('tb_category_type'); ?></th> 
              <th><?php echo $this->lang->line('tb_create'); ?></th> 
              <th><?php echo $this->lang->line('tb_category_status'); ?></th>
...
<script type="text/javascript">
       $(document).ready(function(){  
        ...
        var postListingUrl =  BASEURL+"admin/app/categoryAjaxlist";
