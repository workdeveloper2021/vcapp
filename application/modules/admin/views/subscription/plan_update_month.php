...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-8">
      <a href="<?php echo site_url();?>admin/subscription/plan_list_month" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/subscription/plan_update_submit_month', $attributes, $hidden);
            ?>
