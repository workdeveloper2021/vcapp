    ...
    <div class="col-md-12 col-sm-12 col-xs-12">   
          ...
          <div class="row">
                ...
                <div class="col-md-6 text-right">
                  ...
                  <a class="btn btn-active waves-effect m-b-10" href="<?php echo base_url("admin/subscription/exportCsvSubscrUsers");?>" title="<?php echo $this->lang->line('btn_export_csv_text'); ?>"><?php echo $this->lang->line('btn_export_csv_text'); ?></a>
...
<script type="text/javascript">
       $(document).ready(function(){  
        var sort_table = [0];
        var postListingUrl =  BASEURL+"admin/Subscription/usersAjaxlist";
