    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="row">
        <div class="col-md-6">
         ...
         <a href="<?php echo site_url();?>admin/FurnitureShowrooms/companyshowrooms/<?php echo encode($company); ?>" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
