...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      <a href="<?php echo site_url();?>admin/FurnitureShowrooms/companyshowrooms/<?php echo encode($showroominfo[0]['company_id']);?>" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
      <div class="card-box">
