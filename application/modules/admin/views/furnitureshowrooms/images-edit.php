...
<section class="content">
  <div class="row"> 
    ...
    <div class="col-md-12">
      <a href="<?php echo site_url();?>admin/FurnitureShowrooms/image360list/<?php echo encode($data['showroom_id']);?>" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
      <div class="card-box">
            ...
            ?>
              ...
              ?>     
                <div style="padding:15px 0px" class="row showcod<?= $key+1 ?>' removecla<?= $key+1 ?>">
                    ...
                    <?php 
                      $modal = $this->db->where('img360_id' ,$cod[$key]['id'])->get('furitureshowroom_3d_models')->result_array();
