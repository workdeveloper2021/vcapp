...
<!-- <div class="backlayer-watermark">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">  
     <a href="<?php echo site_url();?>admin/app/videos_update" class="btn btn-back"><?php echo $this->lang->line('add_video'); ?></a>  <br /><br />  
      <div class="card-box"> 
        ...
        <table id="planlist" class="table table-bordered">
            ...
            <tr>
              ...
              <th><?php echo $this->lang->line('tb_video_title'); ?></th>
              <th><?php echo $this->lang->line('tb_video_url'); ?></th>
              <th><?php echo $this->lang->line('tb_video_desc'); ?></th>
              <th><?php echo $this->lang->line('tb_create'); ?></th> 
              <th><?php echo $this->lang->line('tb_video_status'); ?></th>
...
<script type="text/javascript">
       $(document).ready(function(){  
        var sort_table = [0,4];
        var postListingUrl =  BASEURL+"admin/app/videosAjaxlist";
