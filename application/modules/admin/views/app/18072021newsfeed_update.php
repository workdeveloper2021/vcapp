      ...
      <div class="card-box">
            ...
            ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="file" name="newsfeed_url" class="form-control" id="inputName" value="<?php echo $url ?>" placeholder="<?php echo $this->lang->line('tb_newsfeed_url'); ?>" <?php if($url==""){ ?> required <?php } ?>><br/>
                       <?php if($url!=""){ ?>
                        <img src="<?php echo base_url().'uploads/newsfeed/'.$url; ?>" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <textarea name="description" class="form-control" id="inputName" placeholder="<?php echo $this->lang->line('tb_newsfeed_desc'); ?>" required ><?php echo $description ?></textarea>
