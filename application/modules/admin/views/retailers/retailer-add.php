...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      <a href="<?php echo site_url();?>admin/retailers/companyRetailers/<?php echo $cid;?>" class="btn btn-back"><?php echo $this->lang->line('back_to_list_btn'); ?></a>  <br /><br />
      <div class="card-box">
            ...
            <?php 
              ...
              echo form_open_multipart('admin/retailers/retailerAddSubmit/'.$cid, $attributes, $hidden);
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-12">
                      <button type="submit" class="btn btn-info"><?php echo $this->lang->line('btn_add_retailer'); ?></button>
                    </div>
                  </div>
