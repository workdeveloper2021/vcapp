          ...
          <form action="<?php echo base_url() ?>admin/showrooms/unblock_showroom" class="d-inline" data-parsley-validate novalidate method="post">
             ...
             <button type="submit" class="btn btn-danger">Inactive</button>
                ...
                <div class="col-md-6 text-right">
                   ...
                   <a class="btn btn-active waves-effect m-b-10" style="width: 15%;" href="<?php echo base_url("admin/retailers/addRetailers/".encode($cid));?>" title="<?php echo $this->lang->line('btn_add_retailer'); ?>"><?php echo $this->lang->line('btn_add_retailer'); ?></a>
      ...
      <div class="card-box">
        ...
        <table id="userList" class="table table-bordered">
            ...
            <tr>
              ...
              <th nowrap=""><?php echo $this->lang->line('company_retailer_name'); ?></th>
              <th nowrap=""><?php echo $this->lang->line('company_retailer_email'); ?></th>
              <th nowrap=""><?php echo $this->lang->line('company_retailer_country'); ?></th>
              <th nowrap=""><?php echo $this->lang->line('company_retailer_city'); ?></th>
              <th nowrap=""><?php echo $this->lang->line('generated_mail_count_to_retailer'); ?></th>
...
<script type="text/javascript">
        ...
        var sort_table = [0,1,6,8];
        var postListingUrl =  BASEURL+"admin/retailers/retailersAjaxlist/"+cid;
