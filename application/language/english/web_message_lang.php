...
$lang["email_not_verify1"]  = "Email is not verify.Please verify first";
$lang["email_not_varify"] = "We need to verify your email address before you can log in. Please check your inbox or spam folder for our Verification email to continue.";
...
$lang["business_update"]  = "Business update successfully";
$lang["business_location_succ"]  = "Rooms updated successfully";
...
$lang["business_time_succ"]  = "Hours of operation saved successfully";
...
$lang["password_notmatch"] = "Your Username or password is incorrect, please check your details and try again"; // "Incorrect Password";
$lang["register_first"] = "Your Username or password is incorrect, please check your details and try again"; // "This User Is Not Register. Please Sign Up First";
...
$lang['number_valid']      = 'Please enter card number';
$lang['expiry_month_valid']      = 'Please enter expiry month';
$lang['expiry_year_valid']      = 'Please enter expiry year';
$lang['cvd_valid']      = 'Please enter cvd';
...
$lang["is_client_visible_required"]  = "Is client visible is required";
$lang["is_one_time_purchase_required"]  = "Is one time purchase is required";
$lang["description_required"]  = "Description is required";
$lang["notes_required"]  = "Notes is required";
$lang["is_recurring_billing_required"]  = "Is recurring billing is required";
$lang["billing_start_from_required"]  = "Billing start from is required";
$lang["age_restriction_required"]  = "Age restriction is required";
$lang["age_over_under_required"]  = "Age over under is required";
...
$lang['passesid_required']= 'Passes Id is required';
...
$lang['day_id_required']  = 'Day Id is required';
$lang['class_repeat_times_required']  = 'Class repeat time is required';
$lang['class_days_prior_signup_required']  = 'Class days prior signup is required';
$lang['class_waitlist_overflow_required']  = 'Class waitlist overflow is required';
$lang['class_status_required']  = 'Class status is required';
$lang["class_scheduled_succ"]  = "Class Scheduled successfully";
$lang["not_found_location"]  = "Room location not found";
//Business Services
$lang['service_name_required']    = 'Service name is required';
$lang['service_name_unique']    = 'Service name already exists';
...
//add services
$lang['service_cancel_policy']  =   "Cancel policy is required";
$lang['tax1_required']  =   "Tax1 rate is required";
$lang['tax1_alpha']  =   "Tax1 accept only alphabet";
$lang['tax2_required']  =   "Tax2 rate is required";
$lang['tax2_alpha']  =   "Tax2 accept only alphabet";


$lang['tax1_rate_required']  =   "Tax1 rate is required";
$lang['tax1_rate_numeric']  =   "Tax1 rate accept only number";
$lang['tax2_rate_required']  =   "Tax2 rate is required";
$lang['tax2_rate_numeric']  =   "Tax2 rate accept only number";

$lang['tip_option_required']    =   "Tip option is required";
$lang['tip_option_alpha']       =   "Tip option accept only alphabet";
$lang['pay_rate_required']      =   "Pay rate is required";
$lang['pay_rate_numeric']       =   "Pay rate accept only number";
$lang['pay_type_required']      =   "Pay rate is required";
$lang['pay_type_numeric']       =   "Pay rate accept only number";
$lang['service_status_required']       =   "Service status is required";
$lang['service_status_numeric']       =   "Pay rate accept only number";
$lang['service_repeat_times_required']  = 'Service repeat time is required';
$lang['service_slot_times_required']  = 'Service slots is required';

$lang['cancel_policy_required']       =   "Cancel policy is required";
$lang['cancel_policy_max_length']       =   "Cancel policy max length 140";
//Business Workshop
...
$lang["workshop_status_required"]   = "Workshop status is required";
$lang["workshop_repeat_times_required"]   = "Workshop repeat times is required";
$lang["workshop_days_prior_signup_required"]   = "Workshop day prior signup is required";
$lang["workshop_waitlist_overflow_required"]   = "Workshop waitlist overflow is required";
...
//Business services
$lang['service_id_required']     = 'Service Id is required';
$lang['service_type_required']     = 'Service type is required';
$lang['slot_id_required']     = 'Slot Id is required';
$lang['token_required']     = 'Token is required';
$lang['slot_already_booked']     = 'Slot already booked';
$lang['slot_id_not_found']     = 'Slot Id not found';
$lang['date_required']           = 'Date is required';
$lang["service_scheduled_succ"]  = "Service Scheduled successfully";
...
//product purchase
$lang['product_book_id_required']   = 'Product book Id is required';
//pass purchase
$lang['pass_book_id_required']   = 'Pass book Id is required';
//Instructors
$lang['instructor_id_required']      = 'Instructor Id is required';
$lang['instructor_id_required']      = 'Instructor Id is required';
$lang['instructor_not_avalible']     = 'Instructor is not available.Please check instructor avaliblity';
...
//registered studio
$lang['register_id_required'] = 'Register Id is required';
$lang['status_required'] = 'Status is required';
$lang["business_register_approve"]  = "Approved successfully";
$lang["business_register_reject"]  = "Rejected successfully";
